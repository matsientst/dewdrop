...
public class ReadModelUtils {
    ...
    public static <T extends Message> org.dewdrop.read.readmodel.ReadModel createReadModel(ReadModelWrapper readModelWrapper) {
        Optional<InMemoryCacheProcessor> inMemoryCacheProcessor = createInMemoryCache(readModelWrapper.getOriginalReadModelClass());

        return new org.dewdrop.read.readmodel.ReadModel(readModelWrapper, inMemoryCacheProcessor);
    }
