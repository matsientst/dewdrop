...
class DewdropSettingsTest {
    @Test
    void construct() {
        DewdropProperties properties = DewdropProperties.builder().connectionString("esdb://localhost:2113?tls=false").streamPrefix("").packageToScan("events.dewdrop").create();
