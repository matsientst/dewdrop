...
class AggregateStateCommandProcessorTest {
    ...
    void process() throws ValidationException, ResultException {
    ...
    void processCommand_noId() throws ValidationException, ResultException {
    ...
    void processCommand_invalidCommandHandlerMethod() throws ValidationException, ResultException {
        try (MockedStatic<AggregateUtils> utilities = mockStatic(AggregateUtils.class)) {
    ...
    void processCommand() throws ResultException, ValidationException {
        AggregateRoot aggregateRoot = mock(AggregateRoot.class);
