package org.dewdrop.streamstore.write;

import static org.dewdrop.streamstore.write.StreamWriter.AGGREGATE_CLR_TYPE_NAME;
import static org.dewdrop.streamstore.write.StreamWriter.CAUSATION_ID;
import static org.dewdrop.streamstore.write.StreamWriter.COMMIT_ID_HEADER;
import static org.dewdrop.streamstore.write.StreamWriter.CORRELATION_ID;
...
import org.dewdrop.read.readmodel.stream.StreamDetails;
...
class StreamWriterTest {
    ...
    void setup() {
        ...
        this.streamWriter = spy(StreamWriter.getInstance(streamDetails, streamStore, eventSerializer));
