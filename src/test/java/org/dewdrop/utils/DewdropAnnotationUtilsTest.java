...
class DewdropAnnotationUtilsTest {
    ...
    @BeforeEach
    void setup() {
        ReflectionsConfigUtils.init("org.dewdrop", List.of("org.dewdrop.fixture.customized"));
    }
    ...
    void getAnnotatedMethods_skipWhenExcluded() {
        ...
        ReflectionsConfigUtils.init("org.dewdrop", List.of("org.dewdrop.fixture.automated"));
