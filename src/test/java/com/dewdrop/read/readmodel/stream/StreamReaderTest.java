...
class StreamReaderTest {
    ...
    @Test
    @DisplayName("nameAndPosition() - Given a call to nameAndPosition(), when the SubscriptionStartStrategy is NOT READ_ALL_START_END, then confirm startFromEnd() is called")
